...
import { FileText, Users, BookOpen, ArrowUpRight, Download, Plus, Upload } from "lucide-react"
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Papers Generated</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+201 new this week</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>You have generated {RECENT_PAPERS.length} papers this week.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-8">
        ...
        <Card className="col-span-3">
          ...
          <CardContent className="grid gap-2">
            ...
            >
              <Plus className="mr-2 h-4 w-4" /> Add Single Question
            </Button>
            <Button
              variant="outline"
              className="justify-start bg-transparent"
            ...
            >
              <Upload className="mr-2 h-4 w-4" /> Bulk Upload Questions
            </Button>
            {user.role !== "student" && (
              <Button
                variant="outline"
