            ...
            <>
              ...
              <div className="space-y-3">
                <p className="font-medium">
                  <b>Question:</b> <ScientificText value={selectedQuestion.text} />
                </p>
                  ...
                  {selectedOptions.map((option, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* OPTION TEXT */}
                        {option.text && (
                          <span className="text-sm"><ScientificText value={option.text} /></span>
                        )}
              ...
              {(selectedQuestion.type === "paragraph" ||
                ...
                <div className="mt-6 rounded bg-muted/20 p-4">
                  ...
                  <p><ScientificText value={selectedQuestion.paragraph || selectedQuestion.text} /></p>
                    ...
                    {selectedSubQuestions.map((sq, index) => (
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <p className="font-medium">
                            {index + 1}. <ScientificText value={sq.text || "Untitled"} />
                          </p>
                                ...
                                >
                                  ...
                                  {subOptionImageUrl ? (
                                    <>
                                      ...
                                      />
                                      {opt.text && <span className="text-sm"><ScientificText value={opt.text} /></span>}
                                    </>
                                  ) : (
