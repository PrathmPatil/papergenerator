          ...
          <CardContent className="p-6">
            <NoteList
              items={[
                ...
                "A, B, C, D labels repeat every 5 questions, matching the INNOSAT OMR sheet.",
                "Black square timing marks, 4.05mm bubbles, and Roll No digits-on-the-left follow the INNOSAT 8th/9th OMR layout.",
